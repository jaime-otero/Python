...
void metodo_lu(const matrix<double>& A, matrix<double>& L, matrix<double>& U, const matrix<double>& b, int nrows, int ncols) {// Realizamos la descomposición LU
